...
namespace hh::gfx {
    ...
    class TexPatControlHH : public TexPatControlBase {
    public:
        ...
        DEFAULT_CREATE_FUNC(TexPatControlHH);

        void SetModel(GOCVisualModel* model);
    };

    class TexPatControl : public TexPatControlHH {
    public:
        DEFAULT_CREATE_FUNC(TexPatControl);
    };
}
