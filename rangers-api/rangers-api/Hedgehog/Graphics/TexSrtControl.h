...
namespace hh::gfx {
    ...
    class TexSrtControlHH : public TexSrtControlBase {
    public:
        ...
        DEFAULT_CREATE_FUNC(TexSrtControlHH);

        void SetModel(GOCVisualModel* model);
    };

    class TexSrtControl : public TexSrtControlHH {
    public:
        DEFAULT_CREATE_FUNC(TexSrtControl);
    };
}
